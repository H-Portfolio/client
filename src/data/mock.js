    ...
    blogs: [
        {
            ...
            category: "Backend",
            image: "https://port-imges.s3.ap-south-1.amazonaws.com/blog-images/Java+EE+-+1.png",
        ...
        },
        {
            ...
            tags: ["java", "J2EE", "Architecture", "Servlet", "EJB", "Application servers"],
            category: "Backend",
            image: "https://port-imges.s3.ap-south-1.amazonaws.com/blog-images/Java+EE+-2.png",
...
const uploadDocument = async (file) => {
  ...
  return s3.upload(params).promise();
        ...
        },
        {
            ...
            "description": "A modern task management system with user authentication, task history tracking, and PostgreSQL database powered by Prisma migrations. Fully Dockerized with backend and frontend containers for seamless deployment.",
            "technologies": ["Node.js", "TypeScript", "Prisma", "PostgreSQL", "JWT", "Nodemailer", "React", "Vite", "TailwindCSS", "Docker", "Docker Compose"],
            "category": "Full-Stack",
