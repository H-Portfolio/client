                ...
                <CardContent className="p-0 space-y-6">
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="flex flex-wrap gap-2">
                      {project.technologies.slice(0, 6).map((tech, index) => (
                        <Badge key={index} variant="secondary" className="bg-gray-800 text-gray-300 border-gray-700 hover:border-purple-400 transition-colors">
                          {tech}
                        </Badge>
                      ))}
                  ...
                  {project.codeSnippet && (
                    <div className="space-y-3">
                      ...
                      <pre className="bg-gray-950 text-gray-400 p-4 rounded-lg overflow-x-auto text-sm border border-purple-500/20">
