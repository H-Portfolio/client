                ...
                <div className="text-center space-y-8">
                    ...
                    <div className="flex justify-center mb-12">
                        <div className="relative">
                            ...
                            {/* Glowing ring effect */}
                            <div
                                className="absolute -inset-2 rounded-full bg-gradient-to-r from-purple-400/10 to-cyan-400/10 blur-2xl animate-pulse"></div>
                        </div>
                    </div>
                    ...
                    <div className="space-y-6">
                        <h1 className="text-6xl lg:text-7xl font-light text-white leading-tight">
                            Hi, I'm{' '}
                            <span
                                className="font-normal bg-gradient-to-r from-purple-400 to-cyan-400 bg-clip-text text-transparent">
                                {data.name.split(' ')[0]}
                            </span>
                        </h1>
